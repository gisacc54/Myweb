...
Pulse
Graphs
nicescroll plugin for jquery - scrollbars like iphone/ipad http://nicescroll.areaaperta.com/
    ...
    JavaScript 63.9% HTML 36.1% 

Latest commit 0c4811b on 25 Jan @inuyaksa inuyaksa committed on GitHub Merge pull request #619 from jmlear/master
	demo 	3.6.8 - many fixes & IE11 compatible 	a year ago
	dist 	3.6.8 - many fixes & IE11 compatible 	a year ago
	MIT.LICENSE 	3.6.0 	2 years ago
	README.md 	3.6.8 - many fixes & IE11 compatible 	a year ago
	bower.json 	Remove Invalid 'main' Entry 	10 months ago
	changelog_3.6.8.txt 	3.6.8 - many fixes & IE11 compatible 	a year ago
	jquery.nicescroll.js 	Merge pull request #619 from jmlear/master 	2 months ago
	jquery.nicescroll.min.js 	Updated .min.js file 	7 months ago
	package.json 	3.6.8 - many fixes & IE11 compatible 	a year ago
	zoomico.png 	3.6.0 	2 years ago
README.md
jQuery.NiceScroll
...
DEPENDENCIES
        ...
        It's a plugin for the jquery framework, you need to include jquery in your scripts. From 1.5.x version and on. (I'd better to use 1.8.3+ minimum)
